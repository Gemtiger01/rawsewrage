...
draw_healthbar(phy_position_x-15,phy_position_y-55,phy_position_x+15,phy_position_y-53,scr_map(hp,0,maxhp,0,100), c_black, c_red,make_colour_rgb(255,145,0),0,true,true);
draw_self();