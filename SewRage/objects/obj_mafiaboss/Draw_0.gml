...
draw_healthbar(phy_position_x-25,phy_position_y-115,phy_position_x+25,phy_position_y-113,scr_map(hp,0,maxhp,0,100), c_black, c_red,make_colour_rgb(255,145,0),0,true,true);
draw_self();